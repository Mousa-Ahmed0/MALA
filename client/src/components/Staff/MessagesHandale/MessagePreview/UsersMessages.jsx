...
export default function UsersMessages({ user }) {
              ...
              <div className="row">
                ...
                <div className="col-5 col-sm-4 col-md-3 d-flex  justify-content-md-start align-items-center p-0">
                  <img
                    ...
                    src={user.firstUser.profilePhoto.url}
                    alt="nav-profile-img"
                  ...
                  <div className="col-6 col-md-12 ">
                    <div className="row">
                      ...
                      <div className="col-6 col-md-5 d-flex align-items-center">
                        <Link
                          to={`/Patient/contactLab/${user._id}`}
                          className="normal-btn btn d-flex justify-content-center align-items-center"
                        >
                          {" "}
                          <i
                            className={`fa-solid  fa-envelope mb-0 text-truncate ${
                              darkMode ? " dark-theme" : ""
                            }`}
                          ></i>
                        </Link>
    ...
    if (searchResults.length === 0 || !searchResults || val === "") {
      if (option === "noValue") {
        ...
        const filteredUsers = allUsers.filter(
          (user) => user.firstUser.usertype === option
        );
  ...
  async function searchForAUser() {
    ...
    let srchResultsArray = allUsers.filter((user) =>
      (
        user.firstUser.firstname.toLowerCase() +
        user.firstUser.lastname.toLowerCase()
